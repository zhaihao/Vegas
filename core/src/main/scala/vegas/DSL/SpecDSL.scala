...
object Vegas {
  ...
  /**
    ...
    */
  def apply(description: OptArg[String] = NoArg,
            name: OptArg[String] = NoArg,
            width: OptArg[Double] = NoArg,
  ...
  /**
    ...
    */
  def layered(description: OptArg[String] = NoArg,
              name: OptArg[String] = NoArg,
              width: OptArg[Double] = NoArg,
              height: OptArg[Double] = NoArg) =
    LayerSpecBuilder(
...
/**
  ...
  */
case class ExtendedUnitSpecBuilder(spec: ExtendedUnitSpec)
    extends SpecBuilder
    with ExtendedUnitSpecDSL {
...
/**
  ...
  */
case class LayerSpecBuilder(spec: LayerSpec)
    extends SpecBuilder
    with LayerSpecDSL {
  import vegas.spec.Spec.Implicits._
...
/**
  ...
  */
case class UnitSpecBuilder(spec: UnitSpec)
    extends SpecBuilder
    with UnitSpecDSL {
  import vegas.spec.Spec.Implicits._
...
object SpecBuilder {
  ...
  implicit class SpecBuilderRenderOps(val sb: SpecBuilder) extends AnyVal {
    ...
    def html(theme: Theme = Theme.Default): StaticHTMLRenderer =
      new StaticHTMLRenderer(sb.toJson,theme)
  }

}

trait ExtendedUnitSpecDSL
    extends EncoderDSL[ExtendedUnitSpecBuilder]
    with DataDSL[ExtendedUnitSpecBuilder]
    with TransformDSL[ExtendedUnitSpecBuilder]
    with ConfigDSL[ExtendedUnitSpecBuilder] {

  self: ExtendedUnitSpecBuilder =>

  protected[this] val _spec = GenLens[ExtendedUnitSpecBuilder](_.spec)
  protected[this] def _encoding =
    _spec composeLens GenLens[ExtendedUnitSpec](_.encoding)
  protected[this] val _data = _spec composeLens GenLens[ExtendedUnitSpec](
    _.data
  )
  protected[this] val _transform = _spec composeLens GenLens[ExtendedUnitSpec](
    _.transform
  )
  protected[this] val _config = _spec composeLens GenLens[ExtendedUnitSpec](
    _.config
  )
...
trait LayerSpecDSL
    extends DataDSL[LayerSpecBuilder]
    with TransformDSL[LayerSpecBuilder]
    with ConfigDSL[LayerSpecBuilder] {
  ...
  protected[this] val _transform = _spec composeLens GenLens[LayerSpec](
    _.transform
  )
...
trait UnitSpecDSL
    extends UnitEncoderDSL[UnitSpecBuilder]
    with DataDSL[UnitSpecBuilder]
    with TransformDSL[UnitSpecBuilder]
    with ConfigDSL[UnitSpecBuilder] {
  self: UnitSpecBuilder =>

  protected[this] val _spec = GenLens[UnitSpecBuilder](_.spec)
  protected[this] def _encoding =
    _spec composeLens GenLens[UnitSpec](_.encoding)
  protected[this] val _data = _spec composeLens GenLens[UnitSpec](_.data)
  protected[this] val _transform = _spec composeLens GenLens[UnitSpec](
    _.transform
  )
